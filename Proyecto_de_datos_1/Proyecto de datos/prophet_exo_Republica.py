...
Republica_de_chile_pred = pd.read_excel('predicciones.xlsx')
Republica_de_chile_pred = Republica_de_chile_pred.rename(columns={'Time': 'ds', 'República de Chile_predicho': 'y'})
...
merged_data = pd.merge(Republica_de_chile_pred, maximos_minimos, on='ds')
