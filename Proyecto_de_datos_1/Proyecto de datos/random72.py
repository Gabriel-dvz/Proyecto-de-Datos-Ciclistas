...
mape_cabello = mean_absolute_percentage_error(datos['Cabello'], datos['Cabello_imputado'])
mad_cabello = mean_absolute_deviation(datos['Cabello'], datos['Cabello_imputado'])
print(f"CABELLO - MAPE: {mape_cabello}%, MAD: {mad_cabello}")
mapeC1=((datos['Cabello']-datos['Cabello_imputado']))
print(mapeC1)
