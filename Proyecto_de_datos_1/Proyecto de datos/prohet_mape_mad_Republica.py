...
# Cargar datos
#df = pd.read_excel('predicciones.xlsx')
Republica = pd.read_csv('Repúblicad_con_San_Joaquín.csv')
Republica_pred = pd.read_excel('predicciones.xlsx')

# Renombrar las columnas como 'ds' y 'y'
df = Republica_pred.rename(columns={'Time': 'ds', 'República de Chile_predicho': 'y'})
