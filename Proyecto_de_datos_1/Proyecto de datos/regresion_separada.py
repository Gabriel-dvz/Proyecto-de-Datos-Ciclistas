...
# Crear un DataFrame separado para las predicciones de 'Cabello'
df_cabello = datos[['Time', 'Cabello_predicho']].copy()
...
# Crear un DataFrame separado para las predicciones de 'Alameda'
df_alameda = datos[['Time', 'Alameda_predicho']].copy()
...
# Crear un DataFrame separado para las predicciones de 'República de Chile'
df_rep_chile = datos_rep_chile[['Time', 'República de Chile_predicho']].copy()
...
# Crear un DataFrame separado para las predicciones de 'San Juan'
df_san_juan = datos_san_juan[['Time', 'San Juan_predicho']].copy()

# Guardar los nuevos DataFrames en archivos CSV
df_cabello.to_csv('cabello_predicho.csv', index=False)
df_alameda.to_csv('alameda_predicho.csv', index=False)
df_rep_chile.to_csv('republica_de_chile_predicho.csv', index=False)
df_san_juan.to_csv('san_juan_predicho.csv', index=False)
