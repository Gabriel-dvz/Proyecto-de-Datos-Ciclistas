...
SARIMA_model = pm.auto_arima(Alameda_pred['Alameda_predicho'], start_p=1, start_q=1,
                         test='adf',
                         max_p=2, max_q=2,  # Reducir el número máximo de p y q
                         m=7,  # Frecuencia semanal para datos diarios
                         start_P=0, max_P=1,  # Reducir el número máximo de P
                         start_Q=0, max_Q=1,  # Reducir el número máximo de Q
                         seasonal=True,  # Configurar estacionalidad
                         d=None, 
                         D=1,  # Orden de la diferenciación estacional
                         trace=False,
                         error_action='ignore',  
                         suppress_warnings=True, 
                         stepwise=True,
                         max_order=3,  # Limitar el orden total del modelo
                         maxiter=50)  # Limitar el número de iteraciones
