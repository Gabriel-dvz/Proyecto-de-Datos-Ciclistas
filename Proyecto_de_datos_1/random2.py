...
# axs[0].plot(datos_rep_chile['Time'], datos_rep_chile['República de Chile con San Joaquín'], label='República de Chile (original)',  linestyle='-', color='purple')
# axs[0].plot(datos_rep_chile['Time'], datos_rep_chile['República de Chile_predicho'], label='República de Chile (predicho)', linestyle='-', color='brown')
# axs[0].set_ylabel('República de Chile')
# axs[0].legend()

# # Gráfico de San Juan
# axs[1].plot(datos_san_juan['Time'], datos_san_juan['San Juan con Escrivá de Balaguer'], label='San Juan (original)',  linestyle='-', color='cyan')
# axs[1].plot(datos_san_juan['Time'], datos_san_juan['San Juan_predicho'], label='San Juan (predicho)', linestyle='-', color='magenta')
# axs[1].set_ylabel('San Juan')
# axs[1].legend()
...
##ESTE es el code que nos da las calles separadas.
